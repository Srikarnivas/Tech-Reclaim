...
<head>
    ...
    <link rel="stylesheet" href="common_home_page.css">
...
<body>
    ...
    <section class="don-sec" id="donation">
        <div class="container">
            <div class="heading">
                <h2>Login to Your respective Field</h2>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="don-box">
                                <img src="img\USERS.jpg" alt="img">
                                <h3>Individuals</h3>
                                <p>The ones who generate less amount of E-waste</p>
                                <a href="./single_signin_page.php" class="btn1">Sign in</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="don-box">
                                <img src="img\Institution.jpg" alt="img">
                                <h3>Organisation</h3>
                                <p>The ones who generate Large amount of E-waste</p>
                                <a href="./large_signin_page.php" class="btn1">Sign in</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="don-box">
                                <img src="img\REC.jpg" alt="img">
                                <h3>Collection Centers</h3>
                                <p>The Centers which collect the E-waste</p>
                                <a href="collection_signin_page.php" class="btn1">Sign in</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="don-box">
                                <img src="img/IMG-6.png" alt="img" align-img: center;>
                                <h3>Recycle Companies</h3>
                                <p>The companies which Recycle the E-waste</p>
                                <a href="./companies_signin_page.php" class="btn1">Sign in</a>
                            </div>
                        </div>
                    </div>
                </div>
